...
| [docs/arquitetura/modelo-de-dados.md](./docs/arquitetura/modelo-de-dados.md) | Entidades e DDL completo |
...
contato. O `.gitignore` cobre os casos comuns, mas ele não pensa por ninguém.
