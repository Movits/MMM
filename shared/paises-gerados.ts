// Lista de países ISO 3166-1 alfa-2 — ARQUIVO GERADO, não edite à mão.
//
// Refaça com:
 ...
 * de mexer na tela.
 */
export const FONTE_DOS_PAISES = "GeoNames countryInfo (CC BY 4.0)";
export const FONTE_DOS_PAISES_URL = "https://www.geonames.org";
