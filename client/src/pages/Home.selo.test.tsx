...
/**
 * Selo do Hero para leitor de tela (validação da #116 pelo Roberto, 14/09): o
 * selo mostra trechos separados por " • " e esconde os marcadores visíveis com
 * aria-hidden, mas o `sr-only` lia o t("hero.badge") cru, então o leitor de
 * tela falava os dois "•" ("ponto", "bullet"...). Agora o `sr-only` recebe os
