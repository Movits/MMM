...
const SUGGESTIONS = [
  "Quem conheço na Nigéria?",
  "Quem trabalha com saúde?",
  "Quem exporta medicamentos?",
  "Quem conhece ministros?",
  "Quem trabalha com mineração?",
  "Quem pode abrir mercado na Europa?",
];
  ...
  <main className="min-h-screen px-4 py-8 md:px-8 text-white bg-transparent">
    <div className="max-w-5xl mx-auto">
      <section className="rounded-3xl border border-amber-400/20 bg-[radial-gradient(circle_at_top_right,rgba(245,166,35,.15),transparent_38%),rgba(8,18,31,.82)] p-6 md:p-9 overflow-hidden relative">
        ...
        <div className="relative"><p className="text-amber-300 text-xs font-bold tracking-[.18em]">MEMÓRIA INTELIGENTE</p><h1 className="text-3xl md:text-4xl font-bold mt-2">Pergunte sobre a sua rede com as suas palavras</h1><p className="max-w-2xl mt-3 text-white/60">Encontre contatos, contextos e conversas privadas sem precisar lembrar palavras exatas. As respostas usam apenas o conteúdo da sua conta.</p>
