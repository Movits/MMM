...
/**
 * Pedido do Rosber (14/09 20:44), com o comportamento da PR #133 do Gabriel: no
 * cadastro, passo 2 "Sua especialidade", bloco "Tipo de pessoa", quem escolhe
 * Pessoa Jurídica, MEI ou Sem fins lucrativos vê o campo "Número de Cadastro
 * Empresarial" (não mais "CNPJ"), sem máscara nem hífen e sem o limite de 14
 * dígitos do CNPJ. O campo continua obrigatório para esses três tipos: vazio, o
 * botão de avançar não libera.
 *
...
const ROTULO = "Número de Cadastro Empresarial";
...
function campoDoCadastro(): HTMLInputElement {
  ...
  expect(campo, "campo do Número de Cadastro Empresarial não encontrado").toBeTruthy();
  return campo as HTMLInputElement;
}

describe("Onboarding — Número de Cadastro Empresarial no lugar do CNPJ", () => {
  beforeEach(() => {
    vi.useFakeTimers();
  ...
  it.each([
    ...
    // Rótulo novo na tela, com as maiúsculas do pedido.
