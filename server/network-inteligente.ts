 ...
 *
 * O que NÃO está aqui, porque não existe: contatos disponibilizados à rede,
 * matches com a rede global, intermediações, negócios, comissões e consumo de
 * minutos no mês. Devolver zero nesses campos seria simular o recurso.
 */
...
export type ResumoDoNetworkInteligente = {
  ...
  contatos: { total: number; incompletos: number; amostraIncompletos: ContatoIncompleto[] };
